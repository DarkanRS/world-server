...
abstract class PluginScriptDefinition {
    ...
    fun onObjectClick(objectNamesOrIds: Array<Any>, tiles: Array<Tile>?, checkDistance: Boolean = true, eventHandler: (ObjectClickEvent) -> Unit) {
    ...
    fun onObjectClick(objectNamesOrIds: Array<Any>, type: ObjectType, eventHandler: (ObjectClickEvent) -> Unit) {
        objectNamesOrIds.forEach { require(it is String || it is Int) { "objectNamesOrIds must contain only String or Int types" } }
