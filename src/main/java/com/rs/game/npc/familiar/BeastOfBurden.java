		...
		public void handle(ButtonClickEvent e) {
			...
			if (e.getComponentId() == 0) {
				if (e.getPacket() == ClientPacket.IF_OP1)
					...
					e.getPlayer().getTemporaryAttributes().put("bob_item_X_Slot", e.getSlotId());
					e.getPlayer().getTemporaryAttributes().remove("bob_isRemove");
		...
		public void handle(ButtonClickEvent e) {
			...
			if (e.getComponentId() == 27) {
				if (e.getPacket() == ClientPacket.IF_OP1)
					...
					e.getPlayer().getTemporaryAttributes().put("bob_item_X_Slot", e.getSlotId());
					e.getPlayer().getTemporaryAttributes().put("bob_isRemove", Boolean.TRUE);
					e.getPlayer().getPackets().sendRunScriptReverse(108, new Object[] { "Enter Amount:" });
				}
