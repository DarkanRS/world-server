...
public enum PickPocketableNPC {
	...
	MAN(177, 240,
			new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 25, 170, 3223, 3225, 3226, 3237, 3238, 3239, 3240, 3915, 5923, 5924, 7873, 7874, 7875, 7876, 7877, 7878, 7879, 7880, 7881, 7882, 7883, 7884, 8868, 12345, 12346, 12347 },
			new byte[] { 1, 11, 21, 31 },
			new byte[] { 1, 1, 11, 21 },
			8.0, 4, 10,
			new DropTable(995, 3)),
	...
	GUARD(45, 240,
			new short[] { 9, 32, 206, 296, 297, 298, 299, 344, 345, 346, 368, 678, 812, 2699, 2700, 2701, 2702, 2703, 3228, 3229, 3230, 3231, 3232, 3233, 3241, 3407, 3408, 4307, 4308, 4309, 4310, 4311, 5919, 5920, 5921, 5922 },
	...
	BANDIT(35, 240,
			new short[] { 1880, 1881, 1926, 1931, 5050, 6174, 6388 },
			new byte[] { 55, 65, 75, 85 },
			new byte[] { 1, 55, 65, 75 },
			84.3, 4, 50,
			new DropTable(995, 50)),
	...
	GNOME(13, 120,
			new short[] { 66, 67, 68, 159, 160, 161, 168, 169, 2249, 2250, 2251, 2371, 2649, 2650, 6002, 6004 },
	...
	DWARF_TRADER(1, 150,
			new short[] { 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2116, 2117, 2118, 2119, 2120, 2121, 2122, 2123, 2124, 2125, 2126, 8824, 8827 },
