...
public class Summoning {
	...
	public enum Scroll {
		HOWL(12425, ScrollTarget.ENTITY, "Scares non-player opponents, causing them to retreat. However, this lasts for only a few seconds.", 0.1, 3),
		DREADFOWL_STRIKE(12445, ScrollTarget.MEME, "DESCRIPTION", 0.1, 3),
		FETCH_CASKET(19621, ScrollTarget.MEME, "DESCRIPTION", 0.1, 12),
		EGG_SPAWN(12428, ScrollTarget.MEME, "DESCRIPTION", 0.2, 6),
		SLIME_SPRAY(12459, ScrollTarget.MEME, "DESCRIPTION", 0.2, 3),
		STONY_SHELL(12533, ScrollTarget.MEME, "DESCRIPTION", 0.2, 12),
		PESTER(12838, ScrollTarget.MEME, "DESCRIPTION", 0.5, 3),
		ELECTRIC_LASH(12460, ScrollTarget.MEME, "DESCRIPTION", 0.4, 6),
		VENOM_SHOT(12432, ScrollTarget.MEME, "DESCRIPTION", 0.9, 6),
		FIREBALL(12839, ScrollTarget.MEME, "DESCRIPTION", 1.1, 6),
		CHEESE_FEAST(12430, ScrollTarget.MEME, "DESCRIPTION", 2.3, 6),
		SANDSTORM(12446, ScrollTarget.MEME, "DESCRIPTION", 2.5, 6),
		COMPOST_GENERATE(12440, ScrollTarget.MEME, "DESCRIPTION", 0.6, 12),
		EXPLODE(12834, ScrollTarget.MEME, "DESCRIPTION", 2.9, 3),
		VAMPYRE_TOUCH(12477, ScrollTarget.MEME, "DESCRIPTION", 1.5, 4),
		INSANE_FEROCITY(12433, ScrollTarget.MEME, "DESCRIPTION", 1.6, 12),
		MULTICHOP(12429, ScrollTarget.MEME, "DESCRIPTION", 0.7, 3),
		CALL_TO_ARMS(12443, ScrollTarget.MEME, "DESCRIPTION", 0.7, 3),
		BRONZE_BULL(12461, ScrollTarget.MEME, "DESCRIPTION", 3.6, 6),
		UNBURDEN(12431, ScrollTarget.MEME, "DESCRIPTION", 0.6, 12),
		HERBCALL(12422, ScrollTarget.MEME, "DESCRIPTION", 0.8, 12),
		EVIL_FLAMES(12448, ScrollTarget.MEME, "DESCRIPTION", 2.1, 6),
		PETRIFYING_GAZE(12458, ScrollTarget.MEME, "DESCRIPTION", 0.9, 3),
		IRON_BULL(12462, ScrollTarget.MEME, "DESCRIPTION", 4.6, 6),
		IMMENSE_HEAT(12829, ScrollTarget.MEME, "DESCRIPTION", 2.3, 6),
		THIEVING_FINGERS(12426, ScrollTarget.MEME, "DESCRIPTION", 0.9, 12),
		BLOOD_DRAIN(12444, ScrollTarget.MEME, "DESCRIPTION", 2.4, 6),
		TIRELESS_RUN(12441, ScrollTarget.MEME, "DESCRIPTION", 0.8, 8),
		ABYSSAL_DRAIN(12454, ScrollTarget.MEME, "DESCRIPTION", 1.1, 6),
		DISSOLVE(12453, ScrollTarget.MEME, "DESCRIPTION", 5.5, 6),
		FISH_RAIN(12424, ScrollTarget.MEME, "DESCRIPTION", 1.1, 12),
		STEEL_BULL(12463, ScrollTarget.MEME, "DESCRIPTION", 5.6, 6),
		AMBUSH(12836, ScrollTarget.MEME, "DESCRIPTION", 5.7, 3),
		RENDING(12840, ScrollTarget.MEME, "DESCRIPTION", 5.7, 3),
		GOAD(12835, ScrollTarget.MEME, "DESCRIPTION", 5.7, 6),
		DOOMSPHERE(12455, ScrollTarget.MEME, "DESCRIPTION", 5.8, 3),
		DUST_CLOUD(12468, ScrollTarget.MEME, "DESCRIPTION", 3, 6),
		ABYSSAL_STEALTH(12427, ScrollTarget.MEME, "DESCRIPTION", 1.9, 20),
		OPHIDIAN_INCUBATION(12436, ScrollTarget.MEME, "DESCRIPTION", 3.1, 3),
		POISONOUS_BLAST(12467, ScrollTarget.MEME, "DESCRIPTION", 3.2, 6),
		MITHRIL_BULL(12464, ScrollTarget.MEME, "DESCRIPTION", 6.6, 6),
		TOAD_BARK(12452, ScrollTarget.MEME, "DESCRIPTION", 1, 6),
		TESTUDO(12439, ScrollTarget.MEME, "DESCRIPTION", 0.7, 20),
		SWALLOW_WHOLE(12438, ScrollTarget.MEME, "DESCRIPTION", 1.4, 3),
		FRUITFALL(12423, ScrollTarget.MEME, "DESCRIPTION", 1.4, 6),
		FAMINE(12830, ScrollTarget.MEME, "DESCRIPTION", 1.5, 12),
		ARCTIC_BLAST(12451, ScrollTarget.MEME, "DESCRIPTION", 1.1, 6),
		RISE_FROM_THE_ASHES(14622, ScrollTarget.MEME, "DESCRIPTION", 8, 5),
		VOLCANIC_STRENGTH(12826, ScrollTarget.MEME, "DESCRIPTION", 7.3, 12),
		MANTIS_STRIKE(12450, ScrollTarget.MEME, "DESCRIPTION", 3.7, 6),
		CRUSHING_CLAW(12449, ScrollTarget.MEME, "DESCRIPTION", 3.7, 6),
		INFERNO(12841, ScrollTarget.MEME, "DESCRIPTION", 1.5, 6),
		ADAMANT_BULL(12465, ScrollTarget.MEME, "DESCRIPTION", 7.6, 6),
		DEADLY_CLAW(12831, ScrollTarget.MEME, "DESCRIPTION", 11.4, 6),
		ACORN_MISSILE(12457, ScrollTarget.MEME, "DESCRIPTION", 1.6, 6),
		TITANS_CONSTITUTION(12824, ScrollTarget.MEME, "DESCRIPTION", 7.9, 20),
		REGROWTH(12442, ScrollTarget.MEME, "DESCRIPTION", 1.6, 6),
		SPIKE_SHOT(12456, ScrollTarget.MEME, "DESCRIPTION", 4.1, 6),
		EBON_THUNDER(12837, ScrollTarget.MEME, "DESCRIPTION", 8.3, 4),
		SWAMP_PLAGUE(12832, ScrollTarget.MEME, "DESCRIPTION", 4.1, 6),
		RUNE_BULL(12466, ScrollTarget.MEME, "DESCRIPTION", 8.6, 6),
		HEALING_AURA(12434, ScrollTarget.MEME, "DESCRIPTION", 1.8, 20),
		BOIL(12833, ScrollTarget.MEME, "DESCRIPTION", 8.9, 6),
		MAGIC_FOCUS(12437, ScrollTarget.MEME, "DESCRIPTION", 4.6, 20),
		ESSENCE_SHIPMENT(12827, ScrollTarget.MEME, "DESCRIPTION", 1.9, 6),
		IRON_WITHIN(12828, ScrollTarget.MEME, "DESCRIPTION", 4.7, 12),
		WINTER_STORAGE(12435, ScrollTarget.MEME, "DESCRIPTION", 4.8, 12),
		STEEL_OF_LEGENDS(12825, ScrollTarget.MEME, "DESCRIPTION", 4.9, 12),
		GHASTLY_ATTACK(21453, ScrollTarget.MEME, "DESCRIPTION", 0.9, 20),
		
		SUNDERING_STRIKE_1(18027, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_2(18028, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_3(18029, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_4(18030, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_5(18031, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_6(18032, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_7(18033, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_8(18034, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_9(18035, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SUNDERING_STRIKE_10(18036, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		POISONOUS_SHOT_1(18037, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_2(18038, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_3(18039, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_4(18040, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_5(18041, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_6(18042, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_7(18043, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_8(18044, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_9(18045, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		POISONOUS_SHOT_10(18046, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		SNARING_WAVE_1(18047, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_2(18048, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_3(18049, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_4(18050, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_5(18051, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_6(18052, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_7(18053, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_8(18054, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_9(18055, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SNARING_WAVE_10(18056, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		APTITUDE_1(18057, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_2(18058, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_3(18059, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_4(18060, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_5(18061, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_6(18062, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_7(18063, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_8(18064, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_9(18065, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		APTITUDE_10(18066, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		SECOND_WIND_1(18067, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_2(18068, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_3(18069, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_4(18070, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_5(18071, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_6(18072, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_7(18073, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_8(18074, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_9(18075, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		SECOND_WIND_10(18076, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		GLIMMER_OF_LIGHT_1(18077, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_2(18078, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_3(18079, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_4(18080, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_5(18081, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_6(18082, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_7(18083, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_8(18084, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_9(18085, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		GLIMMER_OF_LIGHT_10(18086, ScrollTarget.MEME, "DESCRIPTION", 0.0, 6),
		
		CLAY_DEPOSIT(14421, ScrollTarget.MEME, "DESCRIPTION", 0.0, 12),
		;
