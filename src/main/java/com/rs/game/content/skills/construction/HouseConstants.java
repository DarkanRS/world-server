...
public class HouseConstants {
	...
	public enum HObject {
		...
		TEAK_TELESCOPE(8349, 13657, 64, 181, new Item(TEAK_PLANK, 2), new Item(MOLTEN_GLASS, 1)),
		MAHOGANY_TELESCOPE(8350, 13658, 84, 580, new Item(MAHOGANY_PLANK, 2), new Item(MOLTEN_GLASS, 1)),
		// CRYSTAL BALL
