...
//			"Ah, I visited with her Royal Highness for the Diamond Jubillee, and I liked it so much I never left! However, I find myself without an income. Care to hire me, for only 375 coins?",
			...
			"You're not aristocracy, but I suppose you'd do. Do you want a good cook for 2250 coins?",
...
//			"I have some experience cooking, and I'm happy to take items to and from the bank.",
			...
			"Well, I can, um. I can cook meals and make tea and everything, and I can even take things to and from the bank for you. I won't make any mistakes this time and everything will be fine!",
			...
			"I have learned my trade under the leash of some of the harshest maters of the Demon Dimensions. I can cook to satisfy the most infernal stomachs, and fly on wings of flame to deposit thine items in the bank in seconds.",
	};
...
//			"I've worked in the Queen's service almost since I was a lad. A high quality of service expected there, let me tell you!",
			...
			"Oh! Oh! I, well I er. It wasn't really my fault, I mean, it was, but not really. I mean, how was I to know that that plate was so valuable? It was just lying around and I don't know art, it just looked like a pretty pattern.",
