...
public enum Pouch {
	...
	SPIRIT_SPIDER(6841, 6842, XPType.CONTROLLED, 00000, 00000, Scroll.EGG_SPAWN, 12059, 10, 0.2, 12.6, Ticks.fromMinutes(16), 2, true),
	THORNY_SNAIL(6806, 6807, XPType.RANGED, 00000, 00000, Scroll.SLIME_SPRAY, 12019, 13, 0.2, 12.6, Ticks.fromMinutes(16), 2, 3),
	GRANITE_CRAB(6796, 6797, XPType.DEFENSIVE, 00000, 00000, Scroll.STONY_SHELL, 12009, 16, 0.2, 21.6, Ticks.fromMinutes(16), 2, true),
	...
	ALBINO_RAT(6847, 6848, XPType.ACCURATE, 00000, 00000, Scroll.CHEESE_FEAST, 12067, 23, 2.3, 202.4, Ticks.fromMinutes(16), 3, true),
	...
	BEAVER(6808, -1, null, 00000, 00000, Scroll.MULTICHOP, 12021, 33, 0.7, 57.6, Ticks.fromMinutes(32), 4, true),
	...
	MACAW(6851, 6852, null, 00000, 00000, Scroll.HERBCALL, 12071, 41, 0.8, 72.4, Ticks.fromMinutes(32), 5, true),
	EVIL_TURNIP(6833, 6834, XPType.RANGED, 00000, 00000, Scroll.EVIL_FLAMES, 12051, 42, 2.1, 184.8, Ticks.fromMinutes(32), 5, true),
	SPIRIT_COCKATRICE(6875, 6876, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12095, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_GUTHATRICE(6877, 6878, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12097, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_SARATRICE(6879, 6880, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12099, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_ZAMATRICE(6881, 6882, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12101, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_PENGATRICE(6883, 6884, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12103, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_CORAXATRICE(6885, 6886, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12105, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	SPIRIT_VULATRICE(6887, 6888, XPType.MAGIC, 00000, 00000, Scroll.PETRIFYING_GAZE, 12107, 43, 0.9, 75.2, Ticks.fromMinutes(32), 5, true),
	PYRELORD(7377, 7378, XPType.AGGRESSIVE, 00000, 00000, Scroll.IMMENSE_HEAT, 12816, 46, 2.3, 202.4, Ticks.fromMinutes(32), 5),
	MAGPIE(6824, -1, null, 00000, 00000, Scroll.THIEVING_FINGERS, 12041, 47, 0.9, 83.2, Ticks.fromMinutes(32), 5, true),
	...
	IBIS(6991, -1, null, 00000, 00000, Scroll.FISH_RAIN, 12531, 56, 1.1, 98.8, Ticks.fromMinutes(32), 6, true),
	...
	STRANGER_PLANT(6827, 6828, XPType.CONTROLLED, 00000, 00000, Scroll.POISONOUS_BLAST, 12045, 64, 3.2, 281.6, Ticks.fromMinutes(48), 7, true),
	...
	FRUIT_BAT(6817, -1, null, 00000, 00000, Scroll.FRUITFALL, 12033, 69, 1.4, 121.2, Ticks.fromMinutes(48), 7, true),
	...
	PHEONIX(8575, 8576, XPType.MAGIC, 00000, 00000, Scroll.RISE_FROM_THE_ASHES, 14623, 72, 3.0, 301.0, Ticks.fromMinutes(48), 8),
	...
	GRANITE_LOBSTER(6849, 6850, XPType.DEFENSIVE, 00000, 00000, Scroll.CRUSHING_CLAW, 12069, 74, 3.7, 325.6, Ticks.fromMinutes(64), 8, true),
	...
	GIANT_ENT(6800, 6801, XPType.CONTROLLED, 00000, 00000, Scroll.ACORN_MISSILE, 12013, 78, 1.6, 136.8, Ticks.fromMinutes(64), 8, true),
	...
	HOARDSTALKER_1(11146, 11147, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_1, 17955, 5, 0.8, 7.1, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_2(11148, 11149, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_2, 17956, 15, 1.3, 22.5, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_3(11150, 11151, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_3, 17957, 25, 1.8, 47.2, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_4(11152, 11153, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_4, 17958, 35, 2.3, 74.2, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_5(11154, 11155, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_5, 17959, 45, 2.8, 107, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_6(11156, 11157, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_6, 17960, 55, 3.3, 167.5, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_7(11158, 11159, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_7, 17961, 65, 3.8, 233.8, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_8(11160, 11161, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_8, 17962, 75, 4.3, 342.4, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_9(11162, 11163, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_9, 17963, 85, 4.8, 538.8, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_10(11164, 11165, XPType.DEFENSIVE, 00000, 00000, Scroll.APTITUDE_10, 17964, 95, 5.3, 835.5, Ticks.fromMinutes(64), 1, true),
	...
	DEATHSLINGER_1(11206, 11207, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_1, 17985, 2, 0.6, 5.7, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_2(11208, 11209, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_2, 17986, 12, 1.1, 20.5, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_3(11210, 11211, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_3, 17987, 22, 1.6, 44.4, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_4(11212, 11213, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_4, 17988, 32, 2.1, 70.4, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_5(11214, 11215, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_5, 17989, 42, 2.6, 102, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_6(11216, 11217, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_6, 17990, 52, 3.1, 160.5, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_7(11218, 11219, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_7, 17991, 62, 3.6, 224.6, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_8(11220, 11221, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_8, 17992, 72, 4.1, 330.8, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_9(11222, 11223, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_9, 17993, 82, 4.6, 524.6, Ticks.fromMinutes(64), 1),
	DEATHSLINGER_10(11224, 11225, XPType.RANGED, 00000, 00000, Scroll.POISONOUS_SHOT_10, 17994, 92, 5.1, 818.5, Ticks.fromMinutes(64), 1),
	
	
	CLAY_POUCH_1(8240, 8241, XPType.ACCURATE, 00000, 00000, Scroll.CLAY_DEPOSIT, 14422, 1, 0.0, 0.0, Ticks.fromMinutes(30), 1, 1),
	CLAY_POUCH_2(8242, 8243, XPType.ACCURATE, 00000, 00000, Scroll.CLAY_DEPOSIT, 14424, 20, 0.0, 0.0, Ticks.fromMinutes(30), 1, 6),
	CLAY_POUCH_3(8244, 8245, XPType.ACCURATE, 00000, 00000, Scroll.CLAY_DEPOSIT, 14426, 40, 0.0, 0.0, Ticks.fromMinutes(30), 1, 12),
	CLAY_POUCH_4(8246, 8247, XPType.ACCURATE, 00000, 00000, Scroll.CLAY_DEPOSIT, 14428, 60, 0.0, 0.0, Ticks.fromMinutes(30), 1, 18),
	CLAY_POUCH_5(8248, 8249, XPType.ACCURATE, 00000, 00000, Scroll.CLAY_DEPOSIT, 14430, 80, 0.0, 0.0, Ticks.fromMinutes(30), 1, 24),
	;
