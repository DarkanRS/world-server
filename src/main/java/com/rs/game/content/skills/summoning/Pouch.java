...
public enum Pouch {
	...
	HOARDSTALKER_1(11146, 11147, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_1, 17955, 5, 0.8, 7.1, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_2(11148, 11149, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_2, 17956, 15, 1.3, 22.5, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_3(11150, 11151, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_3, 17957, 25, 1.8, 47.2, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_4(11152, 11153, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_4, 17958, 35, 2.3, 74.2, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_5(11154, 11155, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_5, 17959, 45, 2.8, 107, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_6(11156, 11157, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_6, 17960, 55, 3.3, 167.5, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_7(11158, 11159, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_7, 17961, 65, 3.8, 233.8, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_8(11160, 11161, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_8, 17962, 75, 4.3, 342.4, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_9(11162, 11163, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_9, 17963, 85, 4.8, 538.8, Ticks.fromMinutes(64), 1, true),
	HOARDSTALKER_10(11164, 11165, XPType.DEFENSIVE, 13684, 13685, Scroll.APTITUDE_10, 17964, 95, 5.3, 835.5, Ticks.fromMinutes(64), 1, true),
