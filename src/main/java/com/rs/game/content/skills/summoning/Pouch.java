...
public enum Pouch {
	...
	DESERT_WYRM(6831, 6832, XPType.AGGRESSIVE, 7794, 8537, Scroll.ELECTRIC_LASH, 12049, 18, 0.4, 31.2, Ticks.fromMinutes(16), 1),
	SPIRIT_SCORPION(6837, 6838, XPType.CONTROLLED, 8127, 8546, Scroll.VENOM_SHOT, 12055, 19, 0.9, 83.2, Ticks.fromMinutes(16), 2),
	SPIRIT_TZ_KIH(7361, 7362, XPType.MAGIC, 8260, 8927, Scroll.FIREBALL, 12808, 22, 1.1, 96.8, Ticks.fromMinutes(16), 3),
	ALBINO_RAT(6847, 6848, XPType.ACCURATE, 16080, 16081, Scroll.CHEESE_FEAST, 12067, 23, 2.3, 202.4, Ticks.fromMinutes(16), 3, "forage_albino_rat"),
	SPIRIT_KALPHITE(6994, 6995, XPType.DEFENSIVE, 8516, 8531, Scroll.SANDSTORM, 12063, 25, 2.5, 220, Ticks.fromMinutes(16), 3, 6),
	COMPOST_MOUND(6871, 6872, XPType.AGGRESSIVE, 7773, 8540, Scroll.COMPOST_GENERATE, 12091, 28, 0.6, 49.8, Ticks.fromMinutes(32), 6, "forage_compost_mound"),
	GIANT_CHINCHOMPA(7353, 7354, XPType.RANGED, 7754, 8922, Scroll.EXPLODE, 12800, 29, 2.5, 255.2, Ticks.fromMinutes(32), 1),
	VAMPYRE_BAT(6835, 6836, XPType.CONTROLLED, 8279, 8563, Scroll.VAMPYRE_TOUCH, 12053, 31, 1.6, 136.0, Ticks.fromMinutes(32), 4),
	HONEY_BADGER(6845, 6846, XPType.AGGRESSIVE, 7929, 8568, Scroll.INSANE_FEROCITY, 12065, 32, 1.6, 140.8, Ticks.fromMinutes(32), 4),
	BEAVER(6808, -1, null, 7721, 8535, Scroll.MULTICHOP, 12021, 33, 0.7, 57.6, Ticks.fromMinutes(32), 4, "forage_beaver"),
	...
	BULL_ANT(6867, 6868, XPType.CONTROLLED, 7894, 8554, Scroll.UNBURDEN, 12087, 40, 0.6, 52.8, Ticks.fromMinutes(32), 5, 9),
	MACAW(6851, 6852, null, 8005, 8553, Scroll.HERBCALL, 12071, 41, 0.8, 72.4, Ticks.fromMinutes(32), 5, "forage_macaw"),
	EVIL_TURNIP(6833, 6834, XPType.RANGED, 8252, 8250, Scroll.EVIL_FLAMES, 12051, 42, 2.1, 184.8, Ticks.fromMinutes(32), 5, "forage_evil_turnip"),
