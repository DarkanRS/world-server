...
public class WerewolveAgility {
	...
	EXIT_COORDS = Tile.of(3543, 3463, 0),
	ENTRANCE_COORDS = Tile.of(3549, 9865, 0);
	//
	...
	//						e.getPlayer().setNextForceMovement(new ForceMovement(e.getPlayer(), 0, Tile.of(x, 3421, 3), 1));
	//					} else if (stage == 2) {
	...
	//			e.getPlayer().setNextForceMovement(new ForceMovement(e.getPlayer(), 1, Tile.of(2484, 3418, 3), 3, ForceMovement.EAST));
	...
	//			public void run() {
	//				if (tick == 0) {
	//					e.getPlayer().setNextForceMovement(new ForceMovement(e.getPlayer(), 1, Tile.of(2485, 3434, 3), 2));
