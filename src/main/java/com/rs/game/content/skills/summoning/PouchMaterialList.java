...
public enum PouchMaterialList {
	...
	CUB_BLOODRAGER_POUCH(17935, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17630, 1) }),
	LITTLE_BLOODRAGER_POUCH(17936, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17632, 1) }),
	NAIVE_BLOODRAGER_POUCH(17937, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17634, 1) }),
	KEEN_BLOODRAGER_POUCH(17938, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17636, 1) }),
	BRAVE_BLOODRAGER_POUCH(17939, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17638, 1) }),
	BRAH_BLOODRAGER_POUCH(17940, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17640, 1) }),
	NAABE_BLOODRAGER_POUCH(17941, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17642, 1) }),
	WISE_BLOODRAGER_POUCH(17942, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17644, 1) }),
	ADEPT_BLOODRAGER_POUCH(17943, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17646, 1) }),
	SACHEM_BLOODRAGER_POUCH(17944, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17648, 1) }),
	CUB_STORMBRINGER_POUCH(17945, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17448, 1) }),
	LITTLE_STORMBRINGER_POUCH(17946, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17450, 1) }),
	NAIVE_STORMBRINGER_POUCH(17947, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17452, 1) }),
	KEEN_STORMBRINGER_POUCH(17948, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17454, 1) }),
	BRAVE_STORMBRINGER_POUCH(17949, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17456, 1) }),
	BRAH_STORMBRINGER_POUCH(17950, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17458, 1) }),
	NAABE_STORMBRINGER_POUCH(17951, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17460, 1) }),
	WISE_STORMBRINGER_POUCH(17952, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17462, 1) }),
	ADEPT_STORMBRINGER_POUCH(17953, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17464, 1) }),
	SACHEM_STORMBRINGER_POUCH(17954, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17466, 1) }),
	CUB_HOARDSTALKER_POUCH(17955, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17424, 1) }),
	LITTLE_HOARDSTALKER_POUCH(17956, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17426, 1) }),
	NAIVE_HOARDSTALKER_POUCH(17957, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17428, 1) }),
	KEEN_HOARDSTALKER_POUCH(17958, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17430, 1) }),
	BRAVE_HOARDSTALKER_POUCH(17959, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17432, 1) }),
	BRAH_HOARDSTALKER_POUCH(17960, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17434, 1) }),
	NAABE_HOARDSTALKER_POUCH(17961, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17436, 1) }),
	WISE_HOARDSTALKER_POUCH(17962, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17438, 1) }),
	ADEPT_HOARDSTALKER_POUCH(17963, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17440, 1) }),
	SACHEM_HOARDSTALKER_POUCH(17964, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17442, 1) }),
	CUB_SKINWEAVER_POUCH(17965, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(18159, 2) }),
	LITTLE_SKINWEAVER_POUCH(17966, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(18161, 2) }),
	NAIVE_SKINWEAVER_POUCH(17967, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(18163, 2) }),
	KEEN_SKINWEAVER_POUCH(17968, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18165, 2) }),
	BRAVE_SKINWEAVER_POUCH(17969, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18167, 2) }),
	BRAH_SKINWEAVER_POUCH(17970, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18169, 2) }),
	NAABE_SKINWEAVER_POUCH(17971, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(18171, 2) }),
	WISE_SKINWEAVER_POUCH(17972, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(18173, 2) }),
	ADEPT_SKINWEAVER_POUCH(17973, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(18175, 2) }),
	SACHEM_SKINWEAVER_POUCH(17974, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(18177, 2) }),
	CUB_WORLDBEARER_POUCH(17975, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17995, 1) }),
	LITTLE_WORLDBEARER_POUCH(17976, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17997, 1) }),
	NAIVE_WORLDBEARER_POUCH(17977, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17999, 1) }),
	KEEN_WORLDBEARER_POUCH(17978, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18001, 1) }),
	BRAVE_WORLDBEARER_POUCH(17979, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18003, 1) }),
	BRAH_WORLDBEARER_POUCH(17980, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(18005, 1) }),
	NAABE_WORLDBEARER_POUCH(17981, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(18007, 1) }),
	WISE_WORLDBEARER_POUCH(17982, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(18009, 1) }),
	ADEPT_WORLDBEARER_POUCH(17983, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(18011, 1) }),
	SACHEM_WORLDBEARER_POUCH(17984, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(18013, 1) }),
	CUB_DEATHSLINGER_POUCH(17985, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17682, 2) }),
	LITTLE_DEATHSLINGER_POUCH(17986, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17684, 2) }),
	NAIVE_DEATHSLINGER_POUCH(17987, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17686, 2) }),
	KEEN_DEATHSLINGER_POUCH(17988, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17688, 2) }),
	BRAVE_DEATHSLINGER_POUCH(17989, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17690, 2) }),
	BRAH_DEATHSLINGER_POUCH(17990, new Item[] { new Item(526, 0), new Item(18018, 1), new Item(526, 0), new Item(17692, 2) }),
	NAABE_DEATHSLINGER_POUCH(17991, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17694, 2) }),
	WISE_DEATHSLINGER_POUCH(17992, new Item[] { new Item(526, 0), new Item(18019, 1), new Item(526, 0), new Item(17696, 2) }),
	ADEPT_DEATHSLINGER_POUCH(17993, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17698, 2) }),
	SACHEM_DEATHSLINGER_POUCH(17994, new Item[] { new Item(526, 0), new Item(18020, 1), new Item(526, 0), new Item(17700, 2) });
