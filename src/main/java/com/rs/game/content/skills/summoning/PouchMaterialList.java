...
public enum PouchMaterialList {
	...
	NAÏVE_BLOODRAGER_POUCH(17937, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17634, 1) }),
	...
	NAÏVE_STORMBRINGER_POUCH(17947, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17452, 1) }),
	...
	NAÏVE_HOARDSTALKER_POUCH(17957, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17428, 1) }),
	...
	NAÏVE_SKINWEAVER_POUCH(17967, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(18163, 2) }),
	...
	NAÏVE_WORLDBEARER_POUCH(17977, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17999, 1) }),
	...
	NAÏVE_DEATHSLINGER_POUCH(17987, new Item[] { new Item(526, 0), new Item(18017, 1), new Item(526, 0), new Item(17686, 2) }),
