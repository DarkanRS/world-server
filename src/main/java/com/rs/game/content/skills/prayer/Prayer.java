...
public enum Prayer {
	...
	PROTECT_SUMMONING	(false, 4262, 16, 5966, 5995, 35, 2),
	...
	SAP_RANGE			(true, 2675, 2, 6822, 6864, 52, 5d/2),
	SAP_MAGE			(true, 2675, 3, 6823, 6865, 54, 5d/2),
	SAP_SPIRIT			(true, 2675, 4, 6824, 6866, 56, 5d/2),
	BERSERKER			(true, 11000, 5, 6825, 6867, 59, 1d/3),
	DEFLECT_SUMMONING	(true, 4262, 6, 6826, 6868, 62, 2),
	DEFLECT_MAGIC		(true, 2675, 7, 6827, 6869, 65, 2),
	DEFLECT_RANGE		(true, 2677, 8, 6828, 6870, 68, 2),
	DEFLECT_MELEE		(true, 2676, 9, 6829, 6871, 71, 2),
	LEECH_ATTACK		(true, 2675, 10, 6830, 6872, 74, 5d/3),
	LEECH_RANGE			(true, 2675, 11, 6831, 6873, 76, 5d/3),
	LEECH_MAGIC			(true, 2675, 12, 6832, 6874, 78, 5d/3),
	LEECH_DEFENSE		(true, 2675, 13, 6833, 6875, 80, 5d/3),
	LEECH_STRENGTH		(true, 2675, 14, 6834, 6876, 82, 5d/3),
	LEECH_ENERGY		(true, 2675, 15, 6835, 6877, 84, 5d/3),
	LEECH_SPECIAL		(true, 2675, 16, 6836, 6878, 86, 5d/3),
	WRATH				(true, 2682, 17, 6837, 6879, 89, 1d/2),
