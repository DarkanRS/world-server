...
public class ClayWetting {
	...
	private static final int JUG = 1937;
	private static final int BOWL = 1921;
	private static final int BUCKET = 1929;
	
	public static ItemOnItemHandler clayWet = new ItemOnItemHandler(CLAY, new int[] { JUG, BOWL, BUCKET }, e -> e.getPlayer().startConversation(new Dialogue()
