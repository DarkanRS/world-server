...
fun mapKeldagrim() {
    ...
    onObjectClick(6087, 6088) { e ->
        if (e.objectId == 6087) e.player.tele(e.player.transform(if (e.getObject().rotation == 1) 3 else if (e.getObject().rotation == 3) -3 else 0, if (e.getObject().rotation == 2) -3 else if (e.getObject().rotation == 3) 0 else 0, 1))
        else if (e.objectId == 6088) e.player.tele(e.player.transform(if (e.getObject().rotation == 1) -3 else if (e.getObject().rotation == 3) 3 else 0, if (e.getObject().rotation == 2) 3 else if (e.getObject().rotation == 3) 0 else 0, -1))
    }
}
