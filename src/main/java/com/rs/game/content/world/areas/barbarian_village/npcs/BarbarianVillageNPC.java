...
public class BarbarianVillageNPC {
    ...
    public static NPCClickHandler HandleGudrun = new NPCClickHandler(new Object[]{ GUDRUN }, e -> {
        switch (e.getOption()) {
            case "Talk-to" -> {
    ...
    public static NPCClickHandler HandleKjell = new NPCClickHandler(new Object[]{ KJELL }, e -> {
        String[] responses = new String[]{
    ...
    public static NPCClickHandler HandleLitara = new NPCClickHandler(new Object[]{ LITARA }, e -> {
        switch (e.getOption()) {
            case "Talk-to" -> {
                    e.getPlayer().startConversation(new Dialogue()
    ...
    public static NPCClickHandler HandleTassie= new NPCClickHandler(new Object[]{ TASSIE_SLIPCAST }, e -> {
        switch (e.getOption()) {
