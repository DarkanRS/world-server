...
public class LegendsGuild {
	...
	public static ItemOnObjectHandler handleFountainOfHeroes = new ItemOnObjectHandler(new Object[] { 2938 }, null, e -> {
		if (isSkillsNeckOrCombatBrace(e.getItem().getId()) && !e.getItem().getName().toLowerCase().contains("(4)")) {
	...
	public static boolean isSkillsNeckOrCombatBrace(int itemId) {
		return (itemId == 11126) || (itemId == 11124) || (itemId == 11122) || (itemId == 11120) || (itemId == 11118)
				|| (itemId == 11113) || (itemId == 11111) || (itemId == 11109) || (itemId == 11107) || (itemId == 11105);
	}
