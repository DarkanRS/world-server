...
public class Uncategorizeddumpfixes {
    ...
    public static ObjectClickHandler handlepirateshipladders = new ObjectClickHandler(new Object[]{16945, 16946, 16947}, e -> {
        if (e.getObjectId() == 16945)
            ...
            e.getPlayer().tele(e.getPlayer().transform(e.getObject().getRotation() == 2 ? -3 : e.getObject().getRotation() == 0 ? 3 : 0, e.getObject().getRotation() == 1 ? -3 : e.getObject().getRotation() == 3 ? 3 : 0, 1));
    ...
    public static ObjectClickHandler handlekeldagrimpalacestairs = new ObjectClickHandler(new Object[]{6089, 6090}, e -> {
        if (e.getObjectId() == 6089)
            e.getPlayer().tele(e.getPlayer().transform(e.getObject().getRotation() == 3 ? -3 : e.getObject().getRotation() == 1 ? 3 : 0, e.getObject().getRotation() == 3 ? 0 : e.getObject().getRotation() == 1 ? -0 : 0, 1));
