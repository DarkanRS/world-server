...
public class Varrock {
	public static PlayerStepHandler musicBlueMoonInn = new PlayerStepHandler(new WorldTile[] { WorldTile.of(3215, 3395, 0), WorldTile.of(3216, 3395, 0), WorldTile.of(3233, 3396, 0) }, e -> {
	...
	public static PlayerStepHandler musicDancingDonkeyInn = new PlayerStepHandler(new WorldTile[] { WorldTile.of(3274, 3389, 0), WorldTile.of(3275, 3389, 0) }, e -> {
	...
	public static PlayerStepHandler musicBoarsHeadInn = new PlayerStepHandler(new WorldTile[] { WorldTile.of(3281, 3506, 0), WorldTile.of(3280, 3506, 0) }, e -> {
