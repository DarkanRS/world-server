...
@PluginEventHandler
public class Herquin extends Conversation {
	private static final int npcId = 584;
	...
	public Herquin(Player player) {
		super(player);
		addNPC(npcId, HeadE.HAPPY_TALKING, "Do you wish to trade?");
