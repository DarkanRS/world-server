...
public enum AmmoType {
	...
	ABYSSALBANE_ARROW(new int[] { 21655, 21733, 21734, 21735 }, 12, 21, 1107),
	DRAGONBANE_ARROW(new int[] { 21640, 21712, 21713, 21714 }, 12, 21, 1107),
	BASILISKBANE_ARROW(new int[] { 21650, 21719, 21720, 21721 }, 12, 21, 1107),
	WALLASALKIBANE_ARROW(new int[] { 21645, 21726, 21727, 21728 }, 12, 21, 1107),
	...
	ABYSSALBANE_BOLT(new int[] { 21675, 21701, 21702, 21703 }, 27, 955),
	DRAGONBANE_BOLT(new int[] { 21660, 21680, 21681, 21682 }, 27, 955),
	BASILISKBANE_BOLT(new int[] { 21670, 21687, 21688, 21689 }, 27, 955),
	WALLASALKIBANE_BOLT(new int[] { 21665, 21694, 21695, 21696 }, 27, 955),
