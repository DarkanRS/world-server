...
@PluginEventHandler
public class JesseRepairStand extends Conversation {
	public JesseRepairStand(Player player, ItemConstants.ItemDegrade details, Item item, final boolean stand, final int slot) {
		super(player);
