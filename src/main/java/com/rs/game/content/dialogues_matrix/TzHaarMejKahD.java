...
public class TzHaarMejKahD extends Conversation {
	public TzHaarMejKahD(Player p, int NPC) {
		super(p);
		addNPC(NPC, HeadE.SKEPTICAL_HEAD_SHAKE, "You want help JalYt-Ket-" + player.getDisplayName() + "?");
		addOptions("Choose an option:", new Options() {
			@Override
			public void create() {
				option("What is this place?", new Dialogue()
						.addPlayer(HeadE.SKEPTICAL_HEAD_SHAKE, "What is this place?")
						.addNPC(NPC, HeadE.CALM_TALK, "This is the Fight Pit. TzHaar-Xil made it for their sport but many JalYt come here to fight, too.<br>" +
						...
						.addOptions("Choose an option:", new Options() {
								...
								public void create() {
									option("Are there any rules?", new Dialogue()
											...
											.addNPC(NPC, HeadE.CALM_TALK, "No rules, you use whatever you want. Last person standing wins and is declared champion, they stay in the pit for next fight.")
											.addOptions("Choose an option:", new Options() {
												@Override
												public void create() {
													option("Do I win anything?", new Dialogue()
															.addPlayer(HeadE.HAPPY_TALKING, "Do I win anything?")
															.addNPC(NPC, HeadE.CALM_TALK, "You ask a lot questions.<br>Champion gets TokKul as reward, more fights the more TokKul they get.")
															.addPlayer(HeadE.HAPPY_TALKING, "...")
															.addNPC(NPC, HeadE.CALM_TALK, "Before you ask, TokKul is like your coins.")
															.addNPC(NPC, HeadE.CALM_TALK, "Gold is like you JalYt, soft and easily broken, we use hard rock forged in fire like TzHaar!")
													);
				...
				option("Who's the current champion?", new Dialogue()
						...
						.addNPC(NPC, HeadE.CALM_TALK, "Ah that would be Y'Haar-Mej-" + (FightPits.currentChampion == null ? "none" : FightPits.currentChampion) + "!")
				);
				option("What did you call me?", new Dialogue()
						.addPlayer(HeadE.SKEPTICAL_HEAD_SHAKE, "What did you call me?")
						.addNPC(NPC, HeadE.CALM_TALK, "Are you not a JalYt-Ket?")
						.addOptions("Choose an option:", new Options() {
							@Override
							public void create() {
								option("What's a 'JalYt-Ket'?", new Dialogue()
										.addPlayer(HeadE.HAPPY_TALKING, "What's a 'JalYt-Ket'?")
										.addNPC(NPC, HeadE.CALM_TALK, "That what you are...you tough and strong, no?")
										.addNPC(NPC, HeadE.CALM_TALK, "Well, yes I suppose I am...")
										.addNPC(NPC, HeadE.CALM_TALK, "Then you JalYt-Ket!")
										.addOptions("Choose an option:", new Options() {
											@Override
											public void create() {
												option("What are you then?", new Dialogue()
														.addPlayer(HeadE.HAPPY_TALKING, "What are you then?")
														.addNPC(NPC, HeadE.CALM_TALK, "Foolish JalYt, I am TzHaar-Mej one of the mystics of this city.")
														.addOptions("Choose an option:", new Options() {
															@Override
															public void create() {
																option("What other types are there?", new Dialogue()
																		.addPlayer(HeadE.HAPPY_TALKING, "What other types are there?")
																		.addNPC(NPC, HeadE.CALM_TALK, "There are the mighty TzHaar-Key who guard us, the swift TzHaar-Xil who hunt for our food, and the skilled TzHaar-Hur who craft our homes and tools.")
