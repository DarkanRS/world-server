...
public class TzHaarMejKah extends MatrixDialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			stage = 0;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE, "What is this place?", "Who's the current champion?", "What did you call me?", "No I'm fine thanks.");
			break;
		case 0:
			switch (componentId) {
			case OPTION_1:
