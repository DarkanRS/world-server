        ...
        player.startConversation(new Dialogue()
                ...
                .addOptions(ops -> {
                    ...
                    ops.add("Any advice for me?")
                            ...
                            .addNPC(npcid, HeadE.CALM_TALK, "I'll be able to tell you more once I've had a chance to look around, but it should be a matter of finding the chalice's owner, stealing the key, and taking the chalice out of the bank.")
        ...
        player.startConversation(new Dialogue()
                ...
                .addOptions( ops -> {
                    ops.add("That's an appropriate name.")
                            ...
                            .addNPC(npcid, HeadE.CALM_TALK, "Still, it's not so bad... If I hadn't been mocked for my name as a lad, I might never have decided in a fit of ironic pique to learn how to rob from the rich and give to the poor.")
                            .addPlayer(HeadE.CALM_TALK, "Are you the poor in question?")
                            .addNPC(npcid, HeadE.CALM_TALK, "Well, I was.")
                            .addNPC(npcid, HeadE.CALM_TALK, "Having given myself the goods stolen from several rich people, I'm now of limited but comfortable means.")
                            .addNPC(npcid, HeadE.CALM_TALK, "Now, what can I do for you?");
