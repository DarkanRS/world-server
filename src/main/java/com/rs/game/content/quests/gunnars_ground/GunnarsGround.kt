package com.rs.game.content.quests.gunnars_ground
...
import com.rs.game.content.quests.gunnars_ground.dialogues.ChieftainGunthorD
import com.rs.game.content.quests.gunnars_ground.dialogues.DororanD
import com.rs.game.content.quests.gunnars_ground.dialogues.GudrunD
import com.rs.game.content.quests.gunnars_ground.dialogues.JefferyD
import com.rs.game.content.quests.gunnars_ground.instances.npcs.DororanSitting
import com.rs.game.content.quests.gunnars_ground.utils.*
import com.rs.game.content.world.areas.burthorpe.npcs.Dunstan
...
fun mapGunnarsGround() {
    ...
    instantiateNpc(QUESTING_DORORAN) { id, tile -> DororanSitting(id, tile) }
