...
import static com.rs.game.content.quests.handlers.familycrest.FamilyCrest.meetsRequirements;
...
public class DimintheisFamilyCrestD extends Conversation {
	...
	public static NPCClickHandler handleDialogue = new NPCClickHandler(new Object[] { NPC }) {
		...
		public void handle(NPCClickEvent e) {
			e.getPlayer().startConversation(new DimintheisFamilyCrestD(e.getPlayer()).getStart());
		}
	};
}
