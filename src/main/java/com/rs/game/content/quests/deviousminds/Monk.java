...
public class Monk {
    ...
    public static NPCClickHandler handleMonkDeviousMinds = new NPCClickHandler(new Object[]{ MonkDeviousMinds }, new String[]{"Talk-to"}, e -> e.getPlayer().startConversation(new Dialogue()
