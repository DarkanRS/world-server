...
import static com.rs.game.content.quests.handlers.fishingcontest.FishingContest.FISHING_TROPHY;
...
import static com.rs.game.content.quests.handlers.fishingcontest.FishingContest.PIPE_HAS_GARLIC;
...
public class BonzoFishingContestD extends Conversation {
	...
	public static NPCClickHandler handleDialogue = new NPCClickHandler(new Object[] { NPC }) {
		...
		public void handle(NPCClickEvent e) {
			e.getPlayer().startConversation(new BonzoFishingContestD(e.getPlayer()).getStart());
		}
	};
}
