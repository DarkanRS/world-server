				...
				WorldTasks.scheduleLooping(new Task() {
					...
					public void run() {
						...
						if (count == 1) {
							...
							World.sendProjectile(fumus, nex, 2244, 18, 18, 60, 30, 0);
							...
							nex.setNextAnimation(new Animation(6987));
							World.sendProjectile(umbra, nex, 2244, 18, 18, 60, 30, 0);
							...
							nex.setNextAnimation(new Animation(6987));
							World.sendProjectile(cruor, nex, 2244, 18, 18, 60, 30, 0);
							...
							nex.setNextAnimation(new Animation(6987));
							World.sendProjectile(glacies, nex, 2244, 18, 18, 60, 30, 0);
