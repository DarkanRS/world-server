...
public class ArtisansWorkshop  {
	...
	public static final HashMap<String, int[]> ORES = new HashMap<String, int[]>();
	public static final int ORE_IDX = 0, ORE_NOTED = 1, A_ORE_ID = 2, CAP_AMT = 3;
	
	public static final String[] ORE_OPTIONS = new String[] { "Iron", "Coal", "Mithril", "Adamantite", "Runite", "None" };
...
//	}
	...
	private static HashMap<String, ReqItem[]> BAR_SETS = new HashMap<String, ReqItem[]>();
