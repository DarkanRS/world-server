...
public class EnchantedHeadwear {
	...
	public enum Headwear {
		...
		Headwear (int id, int enchantedId, int chargedId, int defenceLevel, int rangeLevel, int magicLevel, int summoningLevel, int scrolls) {
			this.STANDARD_HELMET = id;
			this.ENCHANTED_HELMET = enchantedId;
			this.CHARGED_HELMET = chargedId;
			this.DEFENCE_REQUIREMENT = defenceLevel;
			this.RANGED_REQUIREMENT = rangeLevel;
			this.MAGIC_REQUIREMENT = magicLevel;
			this.SUMMONING_REQUIREMENT = summoningLevel;
			this.SCROLL_LIMIT = scrolls;
		}
