		...
		public void handle(NPCClickEvent e) {
			...
			if(e.getOption().equalsIgnoreCase("talk-to"))
				p.startConversation(new Conversation(p) {
					{
						addNPC(NPC, HeadE.FRUSTRATED, "*sigh* Not another one.");
						addPlayer(HeadE.CALM_TALK, "Another what?");
						addNPC(NPC, HeadE.FRUSTRATED, "Another 'archaeologist'. I'm not going to let you plunder my master's tomb you know.");
						addPlayer(HeadE.HAPPY_TALKING, "That's a shame. Have you got anything else I could do while I'm here?");
						addNPC(NPC, HeadE.FRUSTRATED, "If it will keep you out of mischief I suppose I could set something up for you... I have a few rooms " +
						...
						addOptions("Play OuterPyramidHandler Plunder?", new Options() {
							...
							public void create() {
								option("That sounds like fun; what do I do?", new Dialogue()
										...
										.addNPC(NPC, HeadE.CALM_TALK, "You have five minutes to explore the treasure rooms and collect as many artefacts as " +
												"you can. The artefacts are in the urns, chests and sarcophagi found in each room.")
										.addNPC(NPC, HeadE.CALM_TALK, "There are eight treasure rooms, each subsequent room requires higher thieving skills to" +
												" both enter the room and thieve from the urns and other containers")
										.addNPC(NPC, HeadE.CALM_TALK, "The rewards also become more lucrative the further into the tomb you go. You will also have" +
												" to deactivate a trap in order to enter the main part of each room. ")
										.addNPC(NPC, HeadE.CALM_TALK, "When you want to move onto the next room you need to find the correct door first. " +
												"There are four possible exits... you must open the door before finding out whether it is the exit or not.")
										.addNPC(NPC, HeadE.CALM_TALK, "Opening the doors require picking their locks. Having a lockpick will make this easier.")
										.addNPC(NPC, HeadE.CALM_TALK, "Do you want to do it?")
								...
								option("Not right now.", new Dialogue()
										...
										.addNPC(NPC, HeadE.FRUSTRATED, "Well, get out of here then.")
										);
