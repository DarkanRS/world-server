...
import com.rs.game.player.content.skills.hunter.puropuro.MagicalWheat;
...
//				if (obj.getId() == 25004 || obj.getId() == 1) {
//					System.out.println("Updating obj - " + obj.getId() + " - " +obj.getX() + ", " + obj.getY() + ", " + obj.getPlane() + ", " + obj.getType());
//					obj.setType(ObjectType.SCENERY_INTERACT);
//					obj.setId(1);
//
//				}
//			}
...
//			Region r = World.getRegion(p.getRegionId());
//			for (GameObject obj : r.getObjects()) {
//				if (obj.getId() == 1 || obj.getDefinitions(p).getName().equals("Magical wheat"))
//						continue;
//				boolean northB = false;
//				boolean eastB = false;
//				boolean southB = false;
//				boolean westB = false;
//				boolean horizontal = true;
//				boolean vertical = true;
//
//				GameObject north = World.getObject(new WorldTile(obj.getX(), obj.getY()+1, obj.getPlane()));
//				GameObject northeast = World.getObject(new WorldTile(obj.getX()+1, obj.getY()+1, obj.getPlane()));
//				GameObject east = World.getObject(new WorldTile(obj.getX()+1, obj.getY(), obj.getPlane()));
//				GameObject southeast = World.getObject(new WorldTile(obj.getX()+1, obj.getY()-1, obj.getPlane()));
//				GameObject south = World.getObject(new WorldTile(obj.getX(), obj.getY()-1, obj.getPlane()));
//				GameObject southwest = World.getObject(new WorldTile(obj.getX()-1, obj.getY()-1, obj.getPlane()));
//				GameObject west = World.getObject(new WorldTile(obj.getX()-1, obj.getY(), obj.getPlane()));
//				GameObject northwest = World.getObject(new WorldTile(obj.getX()-1, obj.getY()+1, obj.getPlane()));
//
//				if (north != null && north.getDefinitions(p).getName().equals("Magical wheat"))
//					horizontal = false;
//				if (south != null && south.getDefinitions(p).getName().equals("Magical wheat"))
//					horizontal = false;
//				if (west != null && west.getDefinitions(p).getName().equals("Magical wheat"))
//					vertical = false;
//				if (east != null && east.getDefinitions(p).getName().equals("Magical wheat"))
//					vertical = false;
//
//				if (north != null && obj.getId() == north.getId() && vertical && !horizontal)
//					northB = true;
//				if (east != null && obj.getId() == east.getId() && horizontal && !vertical)
//					eastB = true;
//				if (south != null && obj.getId() == south.getId() && vertical && !horizontal)
//					southB = true;
//				if (west != null && obj.getId() == west.getId() && horizontal && !vertical)
//					westB = true;
//
//				if (northB) {
//					obj.setType(ObjectType.GROUND_DECORATION);
//					obj.setId(100);
//					north.setType(ObjectType.SCENERY_INTERACT);
//					north.setId(1);
//					System.out.println("new WorldTile[] { " +
//							"new WorldTile(" + obj.getX() + ", " + obj.getY() + ", " + obj.getPlane() + "), " +
//							"new WorldTile(" + north.getX() + ", " + north.getY() + ", " + north.getPlane() + ") }");
//
//				}
//				if (eastB) {
//					obj.setType(ObjectType.GROUND_DECORATION);
//					obj.setId(100);
//					east.setType(ObjectType.SCENERY_INTERACT);
//					east.setId(1);
//					System.out.println("new WorldTile[] { " +
//							"new WorldTile(" + obj.getX() + ", " + obj.getY() + ", " + obj.getPlane() + "), " +
//							"new WorldTile(" + east.getX() + ", " + east.getY() + ", " + east.getPlane() + ") }");
//				}
//				if (southB) {
//					obj.setType(ObjectType.GROUND_DECORATION);
//					obj.setId(100);
//					south.setType(ObjectType.SCENERY_INTERACT);
//					south.setId(1);
//					System.out.println("new WorldTile[] { " +
//							"new WorldTile(" + obj.getX() + ", " + obj.getY() + ", " + obj.getPlane() + "), " +
//							"new WorldTile(" + south.getX() + ", " + south.getY() + ", " + south.getPlane() + ") }");
//				}
//				if (westB) {
//					obj.setType(ObjectType.GROUND_DECORATION);
//					obj.setId(100);
//					west.setType(ObjectType.SCENERY_INTERACT);
//					west.setId(1);
//					System.out.println("new WorldTile[] { " +
//							"new WorldTile(" + obj.getX() + ", " + obj.getY() + ", " + obj.getPlane() + "), " +
//							"new WorldTile(" + west.getX() + ", " + west.getY() + ", " + west.getPlane() + ") }");
//				}
//			}
//		});

//		Commands.add(Rights.PLAYER, "pp", "check current tile for puropuro testing", (p, args) -> {
//			p.sendMessage("current tile: " + p.getX() + ", " + p.getY() + ", " + p.getPlane());
...
//			GameObject obj = World.getObject(new WorldTile(p.getX(), p.getY(), p.getPlane()));
//			if (obj != null)
