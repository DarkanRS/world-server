...
import com.rs.game.player.content.holidayevents.christmas.christ19.Christmas2019.Imp;
...
public class SnowImpD extends Conversation {
	...
	public SnowImpD(Player player) {
		...
		case 6:
		case 8:
			Location loc = (Location) player.getChrist19Loc();
