...
public class Easter2022 {
    ...
    public static void EasterEvent2022() {
        ...
        */
        ...
        //Start 50 ticks after startup, or schedule a task to start on April 1st at 00:00.
        int ticksToStart = (currentDate >= startDate) ? 50 : Ticks.fromSeconds((int)(startDate - currentDate));
        int ticksToEnd = Ticks.fromSeconds((int)(endDate - currentDate));

        System.out.println("Ticks to start EE22: " + ticksToStart);
        System.out.println("Ticks to end EE22: " + ticksToEnd);

        final NPC Chocatrice = new NPC(15260, new WorldTile(3208, 3426, 0));
        final NPC EvilChicken = new NPC(15263, new WorldTile(3216,3426,0));

        Chocatrice.faceSouth();
        EvilChicken.faceSouth();

        WorldTasks.schedule(10, () -> {
            //Spawn necessary stuff to start the event.
            ...
            //TODO - TRENT PLEASE FIX TYPO IN STRAIGHT_OUSIDE_WALL_DEC TO BE OUTSIDE
            ...
            World.spawnObjectTemporary(new GameObject(70121, ObjectType.GROUND_INTERACT, 2, new WorldTile(3209,3416,1)), ticksToEnd); //Thessalia's shop hanging banner
            ...
            //Create a repeating event every 2 hours to start a new hunt.
