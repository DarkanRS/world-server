...
public enum CraftablePotion {
	...
	MARRENTILL_POTION_UNF(new Item(93, 1), 9, 1.0, new Item[] { new Item(227, 1), new Item(251, 1) }),
	TARROMIN_POTION_UNF(new Item(95, 1), 5, 1.0, new Item[] { new Item(227, 1), new Item(253, 1) }),
	HARRALANDER_POTION_UNF(new Item(97, 1), 18, 1.0, new Item[] { new Item(227, 1), new Item(255, 1) }),
	RANARR_POTION_UNF(new Item(99, 1), 25, 1.0, new Item[] { new Item(227, 1), new Item(257, 1) }),
	IRIT_POTION_UNF(new Item(101, 1), 40, 1.0, new Item[] { new Item(227, 1), new Item(259, 1) }),
	AVANTOE_POTION_UNF(new Item(103, 1), 48, 1.0, new Item[] { new Item(227, 1), new Item(261, 1) }),
	KWUARM_POTION_UNF(new Item(105, 1), 54, 1.0, new Item[] { new Item(227, 1), new Item(263, 1) }),
	CADANTINE_POTION_UNF(new Item(107, 1), 65, 1.0, new Item[] { new Item(227, 1), new Item(265, 1) }),
	DWARF_WEED_POTION_UNF(new Item(109, 1), 70, 1.0, new Item[] { new Item(227, 1), new Item(267, 1) }),
	TORSTOL_POTION_UNF(new Item(111, 1), 75, 1.0, new Item[] { new Item(227, 1), new Item(269, 1) }),
	LANTADYME_POTION_UNF(new Item(2483, 1), 67, 1.0, new Item[] { new Item(227, 1), new Item(2481, 1) }),
	TOADFLAX_POTION_UNF(new Item(3002, 1), 30, 1.0, new Item[] { new Item(227, 1), new Item(2998, 1) }),
	SNAPDRAGON_POTION_UNF(new Item(3004, 1), 59, 1.0, new Item[] { new Item(227, 1), new Item(3000, 1) }),
	ROGUES_PURSE_POTION_UNF(new Item(4840, 1), 5, 1.0, new Item[] { new Item(227, 1), new Item(1534, 1) }),
	SPIRIT_WEED_POTION_UNF(new Item(12181, 1), 35, 1.0, new Item[] { new Item(227, 1), new Item(12172, 1) }),
	WERGALI_POTION_UNF(new Item(14856, 1), 41, 1.0, new Item[] { new Item(227, 1), new Item(14854, 1) }),
	FELLSTALK_POTION_UNF(new Item(21628, 1), 91, 1.0, new Item[] { new Item(227, 1), new Item(21624, 1) }),
	...
	UGUNE_POTION_UNF(new Item(19999, 1), 55, 1.0, new Item[] { new Item(19994, 1), new Item(19991, 1) }),
	ARGWAY_POTION_UNF(new Item(20000, 1), 56, 1.0, new Item[] { new Item(19994, 1), new Item(19990, 1) }),
	SHENGO_POTION_UNF(new Item(20001, 1), 57, 1.0, new Item[] { new Item(19994, 1), new Item(19992, 1) }),
	SAMADEN_POTION_UNF(new Item(20002, 1), 58, 1.0, new Item[] { new Item(19994, 1), new Item(19993, 1) }),
	
	STRENGTH_POTION(new Item(115, 1), 7, 40.0, new Item[] { new Item(95, 1), new Item(225, 1) }),
	...
	DEFENCE_POTION(new Item(133, 1), 9, 45.0, new Item[] { new Item(93, 1), new Item(948, 1) }),
	...
	ANTIPOISON(new Item(175, 1), 13, 50.0, new Item[] { new Item(93, 1), new Item(235, 1) }),
	...
	GUTHIX_REST(new Item(4419, 1), 18, 59.0, new Item[] { new Item(97, 1), new Item(251, 1) }),
	...
	MAGIC_ESSENCE_UNF(new Item(9019, 1), 57, 1.0, new Item[] { new Item(9017, 1) }),
	...
	MIXTURE__STEP_2(new Item(10919, 1), 65, 52.0, new Item[] { new Item(1526, 1) }),
	SANFEW_SERUM(new Item(10927, 1), 65, 60.0, new Item[] { new Item(10937, 1) }),
	SUMMONING_POTION(new Item(12142, 1), 40, 92.0, new Item[] { new Item(12181, 1) }),
	...
	ANTIPOISON_MIX_2(new Item(11433, 1), 15, 1.0, new Item[] { new Item(177, 1), new Item(11326, 1) }),
	RELICYMS_MIX_2(new Item(11437, 1), 9, 14.0, new Item[] { new Item(4846, 1), new Item(11326, 1) }),
	STRENGTH_MIX_2(new Item(11443, 1), 9, 17.0, new Item[] { new Item(117, 1), new Item(11326, 1) }),
	...
	DEFENCE_MIX_2(new Item(11457, 1), 11, 25.0, new Item[] { new Item(135, 1), new Item(11326, 1) }),
