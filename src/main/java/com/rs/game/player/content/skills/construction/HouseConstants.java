...
public class HouseConstants {
	...
	public static int[] WINDOW_IDS = new int[] { 13099, 13091, 13005, 13112, 13011, 13117, 14354 };
	public static int[] WALL_IDS = new int[] { 13098, 13090, 13004, 13111, 13011, 13116, 14354 };
	public static int[] NAIL_IDS = new int[] { 1539, 4819, 4820, 4821, 4822, 4823, 4824 };
		...
		public Item[] getRequirements(Player player) {
			...
			for (int i = 0;i < reqs.length;i++) {
				if (reqs[i].getId() == NAILS) {
					for (int n = 0;n < NAIL_IDS.length;n++) {
						if (player.getInventory().containsItem(NAIL_IDS[n]))
							item[i] = new Item(NAIL_IDS[n], reqs[i].getAmount());
					}
				} else
					item[i] = reqs[i];
			}
