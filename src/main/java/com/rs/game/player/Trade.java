			...
			if (e.getInterfaceId() == 334) {
				...
				if (e.getComponentId() == 18)
					...
					if (e.getPacket() == ClientPacket.IF_OP1)
						...
						e.getPlayer().getTemporaryAttributes().put("trade_item_X_Slot", e.getSlotId());
						e.getPlayer().getTemporaryAttributes().put("trade_isRemove", Boolean.TRUE);
				...
				if (e.getComponentId() == 0) {
					if (e.getPacket() == ClientPacket.IF_OP1)
						...
						e.getPlayer().getTemporaryAttributes().put("trade_item_X_Slot", e.getSlotId());
						e.getPlayer().getTemporaryAttributes().remove("trade_isRemove");
						e.getPlayer().getPackets().sendRunScriptReverse(108, new Object[] { "Enter Amount:" });
					} else if (e.getPacket() == ClientPacket.IF_OP6)
