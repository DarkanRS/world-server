...
public class LodestoneAction extends Action {
	...
	public static ButtonClickHandler handleLodestoneButtons = new ButtonClickHandler(1092) {
		...
		public void handle(ButtonClickEvent e) {
			...
			if (stone != null) {
				if (stone == Lodestone.BANDIT_CAMP && !Quest.DESERT_TREASURE.meetsRequirements(e.getPlayer(), "to use this lodestone."))
					return;
				if (stone == Lodestone.LUNAR_ISLE && !Quest.LUNAR_DIPLOMACY.meetsRequirements(e.getPlayer(), "to use this lodestone."))
					return;
