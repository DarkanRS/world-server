...
public class DemonSlayer_PlayerVSDelrith extends Controller {
	...
	private void playCutscene() {
        player.lock();
        this.instance = new Instance(401, 419, 4);
        this.spawn = this.instance.getWorldTile(19, 17);
        this.combatStartTile = this.instance.getWorldTile(15, 20);
        player.lock();
