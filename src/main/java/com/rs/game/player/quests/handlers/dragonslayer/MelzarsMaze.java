...
public class MelzarsMaze {
    ...
    public static ObjectClickHandler handleMelzarsMazeLadders = new ObjectClickHandler(new Object[] { 1754, 32015, 25038, 25214, 1752, 2605 }) {
        ...
        public void handle(ObjectClickEvent e) {
            ...
            if(obj.matches(new WorldTile(2928, 3258, 0)))
                return;
            if(obj.matches(new WorldTile(2925, 3258, 0)))
                return;
            if(obj.matches(new WorldTile(2930, 3258, 1)))
                return;
            if(obj.matches(new WorldTile(2937, 3247, 1)))
                return;
