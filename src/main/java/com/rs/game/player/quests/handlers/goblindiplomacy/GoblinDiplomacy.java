...
public class GoblinDiplomacy extends QuestOutline {
            ...
            Options startOptions = new Options() {
                ...
                public void create() {
                    option("Why are you arguing about the color of your armor?", new Dialogue()
                            .addPlayer(HeadE.CALM_TALK, "Why are you arguing about the color of your armor?")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "We decide to celebrate goblin new century")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "By changing the color of our armor")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "Light blue get boring after a bit")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "And we want change")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "Problem is they want different changed to us"));
                    option("Wouldn't you prefer peace?", new Dialogue()
                            .addPlayer(HeadE.CALM_TALK, "Wouldn't you prefer peace?")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "Yeah peace is good as long as it's peace wearing green armor")
                            .addNPC(BENTNOZE, HeadE.FRUSTRATED, "But green too much like skin!")
                            .addNPC(BENTNOZE, HeadE.FRUSTRATED, "Nearly make you look naked!"));
                    option("Do you want me to pick enter an armor color for you?", new Dialogue()
                            .addPlayer(HeadE.CALM_TALK, "Do you want me to pick an armor color for you?")
                            .addPlayer(HeadE.CALM_TALK, "Different to either green or red")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "Hmm me dunno what that'd look like")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "You'd have to bring me some, so us could decide")
                            .addNPC(BENTNOZE, HeadE.FRUSTRATED, "Yep bring us orange armor")
                            .addNPC(WARTFACE, HeadE.FRUSTRATED, "Yep orange might be good", () -> {
    ...
    public static ObjectClickHandler handleGoblinMailChests = new ObjectClickHandler(new Object[] {16559, 16560, 16561 }) {
        ...
        public void handle(ObjectClickEvent e) {
            ...
            if (e.getPlayer().getTempL("goblinMailCrate") == 0) {
                e.getPlayer().setTempL("goblinMailCrate", System.currentTimeMillis());
            } else if ((System.currentTimeMillis() - e.getPlayer().getTempL("goblinMailCrate")) < 900000) {
