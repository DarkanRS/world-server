	...
	public static boolean dumpNPC(String pageName) {
		try {
			...
			if (kills > 500) {
				...
				int goldRate = (int) Math.round((((double) gold / (double) charms) / (double) kills * 100.0));
				int greenRate = (int) Math.round((((double) green / (double) charms) / (double) kills * 100.0));
				int crimsonRate = (int) Math.round((((double) crimson / (double) charms) / (double) kills * 100.0));
				int blueRate = (int) Math.round((((double) blue / (double) charms) / (double) kills * 100.0));
