...
public class MouseMoveHWHandler implements PacketHandler<Player, MouseMoveJav> {

	@Override
	public void handle(Player player, MouseMoveJav packet) {
		player.getRecorder().record(new MouseMove(packet.getTimeRecieved(), 0, packet.getSteps(), true));
	}
}
