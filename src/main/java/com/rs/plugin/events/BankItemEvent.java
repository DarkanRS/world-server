...
public class BankItemEvent implements PluginEvent {
	...
	public BankItemEvent(Player player, Item item) {
		this.player = player;
		this.item = item;
	}
	...
	public static void registerMethod(Class<?> eventType, PluginHandler<? extends PluginEvent> method) {
		for (Object key : method.keys()) {
			...
			if (old != null)
				System.err.println("ERROR: Duplicate BankItem methods for key: " + key);
		}
	}
